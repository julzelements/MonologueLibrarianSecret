...
import { WaveTypeSwitch, DutySwitch, OctaveSwitch, EnvelopeSwitch, TargetSwitch, LFOModeSwitch, OnOffSwitch, PercentSwitch, Switch } from "./switch";
